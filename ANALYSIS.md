# Анализ протоколов видеонаблюдения и технологий разработки

## 1. Анализ протоколов систем видеонаблюдения
...
## 2. Варианты подключения видео потока с камер
...
## 4. Рекомендации для проекта RTSPScout
