...
**RTSPScout** на текущем этапе не использует традиционную базу данных. Данные хранятся в памяти во время выполнения и экспортируются в файлы (JSON, CSV, XML, YAML).
