...
## 10. Графический интерфейс (GUI)

### 10.1. Обязательное требование
**Графический интерфейс является обязательным компонентом приложения** и должен предоставлять все функции CLI через удобный визуальный интерфейс.

### 10.2. Технологический выбор: Fyne
...
### 10.3. Дизайн в стиле Windows 10/11

#### Цветовая схема (Fluent Design System):
- **Светлая тема (по умолчанию):**
  - Фон: #FFFFFF (белый)
...
4. **Детальная информация:**
   - Карточка устройства с основной информацией
